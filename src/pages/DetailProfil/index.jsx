...
const DetailProfile = () => {
    ...
    const getData = () => {
        axios.get(import.meta.env.VITE_API_URL+`/users/${localStorage.getItem("id")}`, {
            headers: {
            ...
            .then((res) => {
                console.log(res)
                setInputData({ ...inputData, name: res.data.data.name, photo_url: res.data.data.photo })
            })
            .catch((err) => {
                console.log(err)
            })
    ...
    const postData = (event) => {
        ...
        axios.put(import.meta.env.VITE_API_URL+`/users`, bodyFormData, {
            headers: {
                Authorization: `Bearer ${localStorage.getItem("logintoken")}`,
            }
        })
